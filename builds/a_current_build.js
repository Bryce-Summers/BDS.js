 ...
 *  Single File concatenated by Grunt Concatenate on 05-04-2017
 */
/*
 * Defines namespaces.
  ...
  BDS.Controller_Group = (function() {
    ...
    Controller_Group.prototype.mouse_down = function(event) {
      ...
      for (i = j = 0, ref = len; j < ref; i = j += 1) {
        ...
        if (controller.isActive()) {
          results.push(controller.mouse_down(event));
        } else {
          results.push(void 0);
        }
      }
    ...
    Controller_Group.prototype.mouse_up = function(event) {
      ...
      for (i = j = 0, ref = len; j < ref; i = j += 1) {
        controller = this._mouse_input_controllers[i];
        if (controller.isActive()) {
          results.push(controller.mouse_up(event));
        } else {
          results.push(void 0);
        }
      }
    ...
    Controller_Group.prototype.mouse_move = function(event) {
      ...
      for (i = j = 0, ref = len; j < ref; i = j += 1) {
        controller = this._mouse_input_controllers[i];
        if (controller.isActive()) {
          results.push(controller.mouse_move(event));
        } else {
          results.push(void 0);
        }
      }
    ...
    Controller_Group.prototype.time = function(dt) {
      ...
      for (i = j = 0, ref = len; j < ref; i = j += 1) {
        ...
        if (controller.isActive()) {
          results.push(controller.time(dt));
        } else {
          results.push(void 0);
        }
      }
    ...
    Controller_Group.prototype.window_resize = function(event) {
      ...
      for (i = j = 0, ref = len; j < ref; i = j += 1) {
        ...
        if (controller.isActive()) {
          results.push(controller.window_resize());
        } else {
          results.push(void 0);
        }
      }
