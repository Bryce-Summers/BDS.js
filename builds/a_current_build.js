...
(function() {
  BDS.Polyline = (function() {
    ...
    * Note: This function interprets this polyline as closed.
    ...
    Polyline.newCircle = function(x, y, radius) {
      var cx, cy, i, j, pts, ref, ref1;
      pts = [];
    ...
    Polyline.newRectangle = function(dim) {
      var pts;
      pts = [];
...
Written by Bryce Summers on ______

Purpose:
 - Directly work with Quads in meshes, etc.
 - Some Intersection tests are more effient with quads.
   http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.44.6955
 */
...
(function() {
  ...
  BDS.Triangle = (function(superClass) {
    ...
    Triangle.prototype.computeCentroid = function() {
      var pt;
      pt = this.a.clone().add(this.b).add(this.c);
      if (!pt.divScalar) {
        debugger;
      }
...
(function() {
  BDS.Controller_Group = (function() {
    ...
    Controller_Group.prototype.mouse_wheel = function(event) {
      var controller, i, j, len, ref;
      len = this._mouse_input_controllers.length;
      for (i = j = 0, ref = len; j < ref; i = j += 1) {
        controller = this._mouse_input_controllers[i];
        if (controller.isActive()) {
          controller.mouse_wheel(event);
        }
      }
    };
...
(function() {
  BDS.Interface_Controller_All = (function() {
    ...
    Interface_Controller_All.prototype.mouse_wheel = function(event) {};
...
(function() {
  BDS.RayQuery = (function() {
    ...
    RayQuery.prototype.reset = function() {
      return this.initialize(this.ray);
    };
