  ...
  BDS.BVH2D = (function() {
    ...
    BVH2D.prototype._ensure_bounding_boxes = function(polygon_list) {
      ...
      for (j = 0, len1 = polygon_list.length; j < len1; j++) {
        ...
        results.push(polygon.generateBoudingBox());
      }
      return results;
    };
    ...
    BVH2D.prototype.query_point = function(pt) {
      ...
      if (this._AABB.containsPoint(pt)) {
        result = this._left.query_point(pt, output_list);
        if (result !== null) {
          return result;
        }
    ...
    BVH2D.prototype.query_box_all = function(box, output_list) {
      var AABB, j, len1, polygon, ref, results;
      if (output_list === void 0) {
        output_list = [];
      }
      if (this._leaf_node) {
