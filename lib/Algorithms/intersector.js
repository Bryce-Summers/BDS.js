...
(function() {
  BDS.Intersector = (function() {
    ...
    Intersector.prototype.detect_intersection_line_segments = function(params) {
      var event, event_queue, i, j, len, ref, tuple, tupleSet;
  ...
  BDS.Intersector.LineTupleSet = (function() {
    ...
    LineTupleSet.prototype.detect_intersection_with_line = function(input_line, params) {};
